...
public class TodoFormController {
    ...
    public String showCreateForm(final TodoItem todoItem){
        return "new-todo-item"; // return the todo item view.
    }

    @PostMapping("/todo")
    public String createTodoItem(@Valid final TodoItem todoItem,
    ...
    public String deleteTodoItem(@PathVariable("id")    final Long id,
                                                        final Model model) {
    ...
    @PostMapping("/todo/{id}")
    public String updateToDoItem(@PathVariable("id")    final Long id,
                                 @Valid                 final TodoItem todoItem,
                                                        final BindingResult result,
                                                        final Model model){
        ...
        return "redirect:/"; // redirects us to home page.
    }
}
